const {ZZFX} = require('./ZzFX_cjs')
//const ZZFX = ZZFX1.ZZFX
console.log(ZZFX)
...
function buildPresetSound(randomseed,presetName='Random',jitter=false) {
    ...
    // Boris: added to disable randomness effect
    if (!jitter) {
        sound.randomness = 0;
    }
